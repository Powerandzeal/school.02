package ru.hogwarts.school02.TestFacultyController;
...
import ru.hogwarts.school02.controller.FacultyController;
...
//            when(facultyRepository.findByColorIgnoreCaseOrNameIgnoreCase
//                    (any(color,name))).thenReturn((Faculty) Collections.singleton(faculty));
//
